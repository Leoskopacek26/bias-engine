...
//   sec: 6 paralel (SEC povoluje 10 req/s na IP, my máme rezervu)
//        Důvod bumpování z 3 → 6: 6-ticker chunk → každý běží paralelně,
//        ne čeká ve frontě. Zarovnáno s FV_CHUNK_SIZE ve frontendu.
const QUEUES = {
  sec:     createQueue({ concurrency: 6, retries: 2 }),
  price:   createQueue({ concurrency: 6, retries: 2 }),

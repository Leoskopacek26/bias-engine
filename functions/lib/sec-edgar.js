...
// Hardcoded CIK lookup pro náš watchlist — obejdeme 1 MB tickerMap fetch
// při cold startu Lambdy. CIK je 10-digit string (zero-padded).
// Zdroj: https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=AAPL
const WATCHLIST_CIKS = {
  'AAPL':'0000320193','MSFT':'0000789019','NVDA':'0001045810','GOOG':'0001652044',
  'AMZN':'0001018724','META':'0001326801','TSLA':'0001318605','NFLX':'0001065280',
  'AMD':'0000002488','INTC':'0000050863','MU':'0000723125','ASML':'0000937966',
  'ADBE':'0000796343','CRM':'0001108524','NOW':'0001373715','ADSK':'0000769397',
  'ON':'0001097864','SMCI':'0000936468','PLTR':'0001321655','UBER':'0001543151',
  'PYPL':'0001633917','V':'0001403161','BAC':'0000070858','BX':'0001393818',
  'ABNB':'0001559720','BKNG':'0001075531','BA':'0000012927','DELL':'0001571996',
  'BRK.B':'0001067983','DUOL':'0001562088','GME':'0001326380','IBKR':'0001381197',
  'DIS':'0001744489','NKE':'0000320187','ROKU':'0001428439','SIRI':'0000908937',
  'TDOC':'0001477449','UAA':'0001336917','MELI':'0001099590','PEP':'0000077476',
  'SHW':'0000089800','SBUX':'0000829224','PHM':'0000822416','PINS':'0001506293',
  'ALGN':'0001097149','TOL':'0000794170','TSSI':'0001114925','AMR':'0001821424',
  'TLN':'0001823575','FICO':'0000814547','LULU':'0001397187','WIX':'0001576789',
  'ANF':'0001018840','RACE':'0001648416','VRSN':'0001014473','HIMS':'0001773751',
  'JD':'0001549802','ZM':'0001585521','TME':'0001721741','PDD':'0001737806',
  'OXY':'0000797468','NXT':'0001772921','TAN':null,'BIDU':'0001329099',
  'TTD':'0001671933','PGEN':'0001356090','CNSW':null,'CNC':'0001071739',
  'S':'0001583708','HTHT':'0001553350','IPCO':null,'CSU':null,
  'BABA':'0001577552','BYDDY':null,'DSY':null,'BTCUSD':null,'ETHUSD':null,
};

async function lookupCIK(ticker) {
  const sym = (ticker || '').toUpperCase().trim();

  // Fast path: hardcoded watchlist
  if (Object.prototype.hasOwnProperty.call(WATCHLIST_CIKS, sym)) {
    const cik = WATCHLIST_CIKS[sym];
    if (cik) return { cik, name: null, matchedAs: sym, fromTable: true };
    return { error: `Ticker ${sym} not in SEC EDGAR (non-US/unlisted/crypto)` };
  }
